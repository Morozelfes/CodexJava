 ...
 * @author Oliver
 */
public class addPersoFrame extends javax.swing.JFrame {

    /**
     * Creates new form addPersoFrame
     */
    public addPersoFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addPersoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addPersoFrame().setVisible(true);
            }
        });
    }
